...
## [0.0.35](https://github.com/chris-han/deepagents/compare/deepagents-cli==0.0.34...deepagents-cli==0.0.35) (2026-03-19)
...
* **cli:** add `-y` and `-S` short flags for auto-approve and shell-allow-list ([#1919](https://github.com/chris-han/deepagents/issues/1919)) ([1036b16](https://github.com/chris-han/deepagents/commit/1036b16276d59d8be669d963901c91aeb8cc2236))
...
* **cli:** add `enabled` flag to hide providers from `/model` switcher ([#1897](https://github.com/chris-han/deepagents/issues/1897)) ([72a216c](https://github.com/chris-han/deepagents/commit/72a216c88f661f9e53eaf92aedce40fac7b76d3c))
...
* **cli:** add animated spinner to non-interactive verbose mode ([#2001](https://github.com/chris-han/deepagents/issues/2001)) ([153f465](https://github.com/chris-han/deepagents/commit/153f465937c09a792119a0e0c8656fa8df29d4e5))
...
* **cli:** add external editor support via `ctrl+x` and `/editor` ([#1861](https://github.com/chris-han/deepagents/issues/1861)) ([bf5d088](https://github.com/chris-han/deepagents/commit/bf5d088d4b3cee6c7e44c3abe3736f9972897896))
...
* **cli:** add rotating tips to welcome banner ([#1898](https://github.com/chris-han/deepagents/issues/1898)) ([d882ca8](https://github.com/chris-han/deepagents/commit/d882ca81e2c9a11768a07824fd5b5ce8579bdcd7))
* **cli:** add sandbox type to trace metadata ([#1845](https://github.com/chris-han/deepagents/issues/1845)) ([59ef941](https://github.com/chris-han/deepagents/commit/59ef94143fc0adabb5f70f308527d98aa1511e44))
...
* **cli:** defer HITL approval menu while user is typing ([#1833](https://github.com/chris-han/deepagents/issues/1833)) ([1d1572e](https://github.com/chris-han/deepagents/commit/1d1572e40cc9f87b97832cbe2b9152c281f8ec92))
...
* **cli:** enhance tool-call UI, add `Ctrl+U` shortcut for chat input ([#1757](https://github.com/chris-han/deepagents/issues/1757)) ([800c552](https://github.com/chris-han/deepagents/commit/800c55213aa4c6515759fb70d36af370feb86302))
...
* **cli:** show cli version in non-interactive header ([#1881](https://github.com/chris-han/deepagents/issues/1881)) ([adacc3f](https://github.com/chris-han/deepagents/commit/adacc3fd0a0f040373b8ef39032978019b5c8e5f))
* **cli:** show editable install source path in help and banner ([#1916](https://github.com/chris-han/deepagents/issues/1916)) ([4ce1cee](https://github.com/chris-han/deepagents/commit/4ce1ceebdd2e4aa6db008061519d3df1e422c2db))
...
* **cli:** show platform-specific ripgrep install command in missing-tool warning ([#1997](https://github.com/chris-han/deepagents/issues/1997)) ([f000ce5](https://github.com/chris-han/deepagents/commit/f000ce58ebb6438397e8eb016b2a788a91fe5754))
...
* **sdk:** add async subagent middleware for remote LangGraph servers ([#1758](https://github.com/chris-han/deepagents/issues/1758)) ([0c5d501](https://github.com/chris-han/deepagents/commit/0c5d501066e7e9cb74737740d9b3c1dfc74751a6))
...
* **sdk:** rename backend methods ([#1907](https://github.com/chris-han/deepagents/issues/1907)) ([7665066](https://github.com/chris-han/deepagents/commit/7665066c093c2583c4cd3bf83515b0906277306f))
* **sdk:** update backend return types for ls, glob, grep ([#1870](https://github.com/chris-han/deepagents/issues/1870)) ([23cf264](https://github.com/chris-han/deepagents/commit/23cf264d0d9784cfce8f8720b125c6ed05a2e2c3))
* **sdk:** update FileData and backend.read return type to support multimodal data ([#1869](https://github.com/chris-han/deepagents/issues/1869)) ([6fb4ede](https://github.com/chris-han/deepagents/commit/6fb4ede894fe5333ea11598468e924442b3b48a7))
...
* **cli:** eliminate autocomplete popup flicker ([#2020](https://github.com/chris-han/deepagents/issues/2020)) ([4b2db1e](https://github.com/chris-han/deepagents/commit/4b2db1eab412ecfb1343fae123777f14e935fcea))
...
* **cli:** escape dynamic strings in rich markup to prevent markup injection ([#1888](https://github.com/chris-han/deepagents/issues/1888)) ([d349d10](https://github.com/chris-han/deepagents/commit/d349d1061647325fdb4ea6322254b24555abf751))
...
* **cli:** harden MCP pre-flight health checks ([#2019](https://github.com/chris-han/deepagents/issues/2019)) ([2b27055](https://github.com/chris-han/deepagents/commit/2b270558fcd846f9f82ffa2bc3b56810b5851d7d))
* **cli:** human-readable duration and consistent dim styling on teardown screen ([#1995](https://github.com/chris-han/deepagents/issues/1995)) ([901a0a4](https://github.com/chris-han/deepagents/commit/901a0a400fccfafbef069d6632acb2227f0aef41))
...
* **cli:** isolate test history writes from real history file ([#2006](https://github.com/chris-han/deepagents/issues/2006)) ([a078257](https://github.com/chris-han/deepagents/commit/a078257ba6f9d9cae540f6eb82a0eabc92d71211))
...
* **cli:** misleading "missing package" error when provider import fails ([#1960](https://github.com/chris-han/deepagents/issues/1960)) ([b90fbad](https://github.com/chris-han/deepagents/commit/b90fbad1335222a3b7ceb469f7f46fedec79ac61))
...
* **cli:** patch model identity in system prompt on `/model` swap ([#2024](https://github.com/chris-han/deepagents/issues/2024)) ([36aecbf](https://github.com/chris-han/deepagents/commit/36aecbf939cafb2d5914620a9e2ec890b02447a4))
...
* **cli:** pre-flight health checks for MCP servers ([#2008](https://github.com/chris-han/deepagents/issues/2008)) ([30d60e3](https://github.com/chris-han/deepagents/commit/30d60e3866bde51a71f607fcd5cbe9dd75c5da75))
...
* **cli:** prevent premature thinking state with parallel subtasks ([#1858](https://github.com/chris-han/deepagents/issues/1858)) ([189104c](https://github.com/chris-han/deepagents/commit/189104c622a5fa874ad1d4be1c18e012cafd605a))
...
* **cli:** replace per-chunk `scroll_end` with anchor to fix scrollbar flicker ([#1891](https://github.com/chris-han/deepagents/issues/1891)) ([a9be236](https://github.com/chris-han/deepagents/commit/a9be2368509f9f2c66537014ae2138253cf0dc39))
* **cli:** resolve config-defined providers during runtime model swaps ([#1941](https://github.com/chris-han/deepagents/issues/1941)) ([aebc660](https://github.com/chris-han/deepagents/commit/aebc660321895909f6b6eb71e72a99ca7754bcf1))
...
* **cli:** show checkmark for `class_path` providers in model selector ([#1899](https://github.com/chris-han/deepagents/issues/1899)) ([4adb712](https://github.com/chris-han/deepagents/commit/4adb712c8eacbcfbc06801c31bfd74fc0705bed3))
...
* **cli:** slash commands should not require server connection / queue ([#1974](https://github.com/chris-han/deepagents/issues/1974)) ([32bd814](https://github.com/chris-han/deepagents/commit/32bd814b98a079778dad092a2e877d8eba22b0fb))
...
* **cli:** surface clear error for missing sandbox provider deps ([#1999](https://github.com/chris-han/deepagents/issues/1999)) ([939f56a](https://github.com/chris-han/deepagents/commit/939f56a19244714fc53158a2fd162e3098b3d56c))
...
* **cli:** update terminology from "fast-path" to "fast-track" for consistency ([c121416](https://github.com/chris-han/deepagents/commit/c1214164f623e71e23a4f3d74de6cec5038fb04d))
...
* **cli:** use ascii-safe glyphs in tool status restore path ([#1895](https://github.com/chris-han/deepagents/issues/1895)) ([2a9cbc8](https://github.com/chris-han/deepagents/commit/2a9cbc8540b2ab77362cbb00764a3533e234891f))
* **cli:** use counter to close history-recall autocomplete race ([#1901](https://github.com/chris-han/deepagents/issues/1901)) ([bfd08af](https://github.com/chris-han/deepagents/commit/bfd08afbc0eca844e565842dff50eddb067e4750))
...
* **cli:** add textual-speedups for Rust-based layout primitives ([#1910](https://github.com/chris-han/deepagents/issues/1910)) ([45b58a1](https://github.com/chris-han/deepagents/commit/45b58a13e14abfb58ef3688cee51a5819d8ca52d))
...
* **cli:** defer heavy imports from startup path ([#2022](https://github.com/chris-han/deepagents/issues/2022)) ([b7f5a99](https://github.com/chris-han/deepagents/commit/b7f5a99ecda2e3b795764e74bc1e9cbc405b7e18))
...
* **cli:** offload blocking path ops from textual event loop ([#1894](https://github.com/chris-han/deepagents/issues/1894)) ([d3eedcc](https://github.com/chris-han/deepagents/commit/d3eedccc7edd21103ca1e586fc365d721f674099))
...
* **cli:** use stream layout for messages container ([#1896](https://github.com/chris-han/deepagents/issues/1896)) ([b35401b](https://github.com/chris-han/deepagents/commit/b35401b885a7651db548f1826ddb24476ecde5b7))


### Reverted Changes

* make summarization test compatible with sdk 0.4.11 ([#1923](https://github.com/chris-han/deepagents/issues/1923)) ([22fd479](https://github.com/chris-han/deepagents/commit/22fd4793196f3b2493ed155330ec325302b6e960))
